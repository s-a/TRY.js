...
This web app is ***developed with Google Chrome*** and tested with the following desktop browsers.  
 ![Chrome](/ico/chrome_64x64.png "Chrome") - Google Chrome on Windows 7 32bit (Version 40.0.2214.111 m) ***OK***
 ![Opera](/ico/opera_64x64.png "Opera") -  Opera on Windows 7 32bit (Version 25.0) ***OK***
 ![Firefox](/ico/firefox_64x64.png "Firefox") -  Firefox on Windows 7 32bit (Version 35.0.1) ***OK***
 ![Internet Explorer](/ico/internet-explorer_64x64.png "Enternet Explorer") -  Internet Explorer on Windows 7 32bit (Version 11.0.16) ***Works*** ecxept of loading packagaes.
 ![Safari](/ico/safari_64x64.png "Safari") -  Safari on Windows 7 32bit (Version 5.1.7) COMPLETE FAIL
