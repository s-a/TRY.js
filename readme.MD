...
To publish your work world wide visit [channel.try.js](https://github.com/s-a/channel.try.js) and follow the instructions. I would be happy to see various mutations and receive pull requests there.  
There are some packages available containg an environment, a test suite and a robot program for demonstration purposes. A robot program is optional so you can create different levels for TRY.js.
