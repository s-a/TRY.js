var Maze = function(doc, elemId, width, height, horizCells, vertCells) {
  this.canvas = doc.getElementById(elemId);
  this.width = width || this.canvas.width;
  this.height = width || this.canvas.height;
  this.ctx = this.canvas.getContext('2d');
  this.horizCells = horizCells || 5;
  this.vertCells = vertCells || 5;
